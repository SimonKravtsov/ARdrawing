...
namespace Leap.Unity.DetectionExamples {
  ...
  public class PinchDraw : MonoBehaviour {
	public setLine setline = new setLine();
    ...
    void Update() {
		_drawRadius = setLine.size;
		_drawColor = setLine.color;
    ...
    private class DrawState {
      ...
      public GameObject BeginNewLine() {
		...
		lineObj.AddComponent<MeshCollider>(); //THIS I ADDED, remove if i fucked up something
		Rigidbody gameObjectsRigidBody = lineObj.AddComponent<Rigidbody>(); //THIS I ADDED, remove if i fucked up something
		gameObjectsRigidBody.useGravity = false;//THIS I ADDED, remove if i fucked up something
		//gameObjectsRigidBody.isKinematic = false;
		gameObjectsRigidBody.isKinematic = true;
		lineObj.AddComponent<Col>();
